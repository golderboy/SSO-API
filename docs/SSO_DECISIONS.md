...
| D-008 | URL และ callback URI ของ application รุ่น pilot คืออะไร | ต้องทำ exact allowlist | Decided for UAT pilot: `https://sobmoeiservice.moph.go.th/testsso/index.php` |
